						...
						<div className="grid md:grid-cols-5 gap-4">
							...
							<div className="space-y-3">
								...
								<button
									...
									className="w-full px-3 py-2 border border-yellow-500 text-yellow-100 bg-yellow-500/20 font-mono text-xs uppercase tracking-wider transition-all hover:bg-yellow-500/30 hover:border-gold-500 hover:text-gold-200 rounded"
								>
									🎲 RANDOMIZE
								</button>
								<button
									onClick={generateImage}
									className="w-full px-3 py-2 border border-purple-500 text-purple-100 bg-purple-500/20 font-mono text-xs uppercase tracking-wider transition-all hover:bg-purple-500/30 hover:border-gold-500 hover:text-gold-200 rounded"
								>
									🎨 GENERATE
								</button>
							</div>
