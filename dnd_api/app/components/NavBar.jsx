		...
		<nav className={`fixed top-0 left-0 right-0 z-[1000] transition-all duration-300 ${
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
				...
				<div className="md:hidden">
					<button className="terminal-text text-lg" aria-label="Menu">⚡</button>
				</div>

				<div className="hidden md:flex">
					<button className="fantasy-button px-5 py-2 text-xs hover:scale-105 transition-transform">Enter Realm</button>
				</div>
			</div>
		</nav>
	)
