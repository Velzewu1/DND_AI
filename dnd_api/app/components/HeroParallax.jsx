...
const backgroundImg = '/assets/dark_fantasy_background.jpg'
const moonImg = '/assets/moon.png'
const castleImg = '/assets/castle.png'
const rocksImg = '/assets/rocks.png'
const frontFogImg = '/assets/front fog.png'
