...
const bottomRocks = '/assets/BottomRocks.png'
		...
		>
			<div className="relative px-8 max-w-4xl mx-auto grid gap-12">
				<div className="text-center space-y-6">
					<h2 className="text-6xl sm:text-7xl fantasy-title ancient-glow vhs-text">Information</h2>
				...
				<div className="grid md:grid-cols-2 gap-6 text-sm">
					...
					<div className="space-y-4 bg-black/85 p-6 border border-green-500/30 rounded shadow-lg shadow-green-500/10">
						...
						<ul className="text-gold-light/80 space-y-2 text-sm font-serif">
							<li className="flex items-start gap-3"><span className="text-[#00ff41] mt-0.5">◆</span><span>Adaptive storytelling engine</span></li>
							<li className="flex items-start gap-3"><span className="text-[#00ff41] mt-0.5">◆</span><span>Procedural dungeon generation</span></li>
							<li className="flex items-start gap-3"><span className="text-[#00ff41] mt-0.5">◆</span><span>Voice-activated gameplay</span></li>
						</ul>
					</div>
